...
<div class="col-4 ">
  ...
  <div class="card-body text-center">
    ...
    <div class="container text-center "><a href="${pageContext.request.contextPath }/land/${l.id}" class="btn btn-primary px-4">Show Details</a></div>
  </div>
</div>
  </div>
</c:forEach>
